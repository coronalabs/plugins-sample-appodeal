...
local textOptions2 = 
{
    text = "Appodeal won't collect your data through this app for personalized advertising. If you consent yo Appodeal personalizing your advertising experience in a different app, we will still collect your data through that app.",   
    x = display.contentWidth / 2,
